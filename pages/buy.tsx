                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                  <form className="space-y-6" action="#" method="POST">
                    <div>
                      ...
                      <div className="mt-2 flex flex-row gap-2 content-center items-center">
                        <input
                          name="amount"
                          type="number"
                          autoComplete="amount"
                          required
                          className="block w-[60%] rounded-md border-0 py-1.5 text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        />
                        <select
                          name="currency"
