...
const StartPage: NextPage = () => {
  ...
  return overlay ? (
    ...
    <div className="isolate overflow-hidden bg-white py-24 px-6 sm:py-32 lg:px-8">
      ...
      <div className="flex items-center p-4 m-2 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <span className="inline-flex items-center mt-5 rounded-full p-2 bg-red-300 text-white group transition-all duration-500 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:outline-none" role="alert">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
        ...
        <span className="whitespace-nowrap inline-block group-hover:max-w-screen-2xl group-focus:max-w-screen-2xl max-w-0 scale-80 group-hover:scale-100 overflow-hidden transition-all duration-500 group-hover:px-2 group-focus:px-2">{obscuredPrivateKey}</span>
                ...
                {salt === "" && 
                 <form action="#" method="POST" className="mx-auto m-16 max-w-xl sm:mt-20">
                  <div><h3 className="text-black m-5">Phone number: {phone}</h3></div>
                 <div className="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
                  
                   <div>
                     <label htmlFor="first-name" className="block text-sm font-semibold leading-6 text-gray-900">
                       Recovery Question (a question that your acquittance would know about)
                     </label>
                   ...
                   <button type="submit" className="group rounded-2xl mt-5 h-12 w-60 bg-green-500 font-bold text-lg text-white relative overflow-hidden">
           
           <span>Link Mobile number </span> <ArrowRightCircleIcon className="h-6 w-6 inline"/> 
              <div className="absolute duration-300 inset-0 w-full h-full transition-all scale-0 group-hover:scale-100 group-hover:bg-white/30 rounded-2xl">
                ...
                {salt !== "" && <div className="text-center">
